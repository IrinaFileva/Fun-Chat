...
export const inputName: HTMLInputElement = new AddInput('input', 'startForm__input')
...
export const inputLastName: HTMLInputElement = new AddInput('input', 'startForm__input')
    .setAttributesAndValues({
        type: 'text',
        required: '',
        minlength: '4',
...
inputName.addEventListener('input', () => {
    ...
    if(inputName.value.length >= 3 && inputLastName.value.length >= 4 &&
        inputLastName.style.borderColor === 'black' && inputName.style.borderColor === 'black' ) {
